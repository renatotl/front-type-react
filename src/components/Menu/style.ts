/*
Vamos construir o style.ts importando o styled-components, seus tipos e todas as tags de estilização para o Menu, e o arquivo vai ficar com o seguinte código
*/
import styled, { css } from "styled-components";
import { Theme } from "types/styled-components";// vem da pasta types
